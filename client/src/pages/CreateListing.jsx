...
export default function CreateListing() {
  ...
  return (
    <main className='p-10 max-w-4xl mx-auto'>
      <h6 className='uppercase text-5xl'>Create Listing</h6>
      <form onSubmit={handleSubmit} className='mt-10 flex flex-col gap-5 sm:flex-row'>
        <div className='flex flex-col gap-4'>
          ...
          <textarea onChange={handleChange} type="text" placeholder='Description' className='p-3 bg-[#E8D9CD]' id='description' required />
          <input onChange={handleChange} type="text" placeholder='Address' className='p-3 bg-[#E8D9CD]' id='address' required />
